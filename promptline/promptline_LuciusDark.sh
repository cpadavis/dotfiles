...
function __promptline {
  ...
  local warn_fg="${wrap}38;5;188${end_wrap}"
  local warn_bg="${wrap}48;5;95${end_wrap}"
  local warn_sep_fg="${wrap}38;5;95${end_wrap}"
  ...
  local z_fg="${wrap}38;5;236${end_wrap}"
  local z_bg="${wrap}48;5;249${end_wrap}"
  local z_sep_fg="${wrap}38;5;249${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
