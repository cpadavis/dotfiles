...
function __promptline {
  ...
  if [[ $KEYMAP = vicmd ]]; then
    ...
    local a_bg="${wrap}48;5;244${end_wrap}"
    local a_sep_fg="${wrap}38;5;244${end_wrap}"
  else
    local a_fg="${wrap}38;5;188${end_wrap}"
    local a_bg="${wrap}48;5;27${end_wrap}"
    local a_sep_fg="${wrap}38;5;27${end_wrap}"
  fi
  local b_fg="${wrap}38;5;241${end_wrap}"
  local b_bg="${wrap}48;5;250${end_wrap}"
  local b_sep_fg="${wrap}38;5;250${end_wrap}"
  local c_fg="${wrap}38;5;238${end_wrap}"
  local c_bg="${wrap}48;5;253${end_wrap}"
  local c_sep_fg="${wrap}38;5;253${end_wrap}"
  local warn_fg="${wrap}38;5;238${end_wrap}"
  local warn_bg="${wrap}48;5;181${end_wrap}"
  local warn_sep_fg="${wrap}38;5;181${end_wrap}"
  local x_fg="${wrap}38;5;238${end_wrap}"
  local x_bg="${wrap}48;5;253${end_wrap}"
  local x_sep_fg="${wrap}38;5;253${end_wrap}"
  local y_fg="${wrap}38;5;241${end_wrap}"
  local y_bg="${wrap}48;5;250${end_wrap}"
  local y_sep_fg="${wrap}38;5;250${end_wrap}"
  local z_fg="${wrap}38;5;255${end_wrap}"
  local z_bg="${wrap}48;5;244${end_wrap}"
  local z_sep_fg="${wrap}38;5;244${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
